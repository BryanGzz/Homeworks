                        ...
                        <div class="tools">
                            <div class="row center-xs">
                                <div class="col-xs-10 col-sm-6 col-md-4 tool">
                                    <div class="card">
                                        <h2 class="color-text2 multi title2">Registrate</h2>
                                        </br>
                                        <form action="" method="POST">
                                            <label class="color-text2 muli title3 center-xs">Nombre:</label>
                                            <input type="text" name="user" class="muli title4 center-xs">
                                            </br>
                                            <label class="color-text2 muli title3 center-xs">Apellido:</label>
                                            <input type="text" name="user" class="muli title4 center-xs">
                                            </br>
                                            ...
                                            <input type="password" name="pass" class="muli title4 center-xs">
                                            </br>
                                            <input type="submit" name="Registrar">
                                            </br>
                                        
                                            <a href="http://localhost:8080/Proyecto/login.jsp" class="title3">Regresar</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
